 ...
 * @author Ingo Mierswa
 */
public class BinominalClassificationPerformanceEvaluatorFixed extends AbstractPerformanceEvaluator {
	...
	public BinominalClassificationPerformanceEvaluatorFixed(OperatorDescription description) {
		super(description);
	}
	...
	public List<PerformanceCriterion> getCriteria() {
		...
		for (int i = 0; i < BinaryClassificationPerformanceFixed.NAMES.length; i++) {
			performanceCriteria.add(new BinaryClassificationPerformanceFixed(i));
		}
