 ...
 */
public class SetDataFixed extends AbstractDataProcessing {
    ...
    public SetDataFixed(OperatorDescription description) {
        super(description);
    ...
    public ExampleSet apply(ExampleSet exampleSet) throws OperatorException {
        ...
        if (exampleIndex<=-1) {
        	...
        	System.out.println("######### SET DATA: ASSUMING ALL DATASET TO BE CHANGED");
    ...
    public ResourceConsumptionEstimator getResourceConsumptionEstimator() {
        return OperatorResourceConsumptionHandler.getResourceConsumptionEstimator(getInputPort(), SetDataFixed.class, null);
    }
}
