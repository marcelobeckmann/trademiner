...
import com.rapidminer.operator.trademiner.eval.LackOfMktdataException;
import com.rapidminer.operator.trademiner.eval.Portfolio;
import com.rapidminer.operator.trademiner.eval.Position;
...
public class OverComplicatedStrategySimulator extends Operator {
	 ...
	 * {@link com.rapidminer.operator.preprocessing.deprecated.OverComplicatedStrategySimulator#PARAMETER_NEWS_DATETIME_ATTRIBUTE }.
	 * 
	 * @param dateTime
